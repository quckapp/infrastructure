...
INSERT INTO quckapp_analytics.api_metrics (
    ...
    (generateUUIDv4(), 'backend-gateway', '/api/v1/auth/login', 'POST', 200, 145, '00000000-0000-0000-0000-000000000001', now() - INTERVAL 7 DAY),
    (generateUUIDv4(), 'workspace-service', '/api/v1/workspaces', 'GET', 200, 32, '00000000-0000-0000-0000-000000000001', now() - INTERVAL 7 DAY),
    (generateUUIDv4(), 'channel-service', '/api/v1/channels', 'GET', 200, 28, '00000000-0000-0000-0000-000000000001', now() - INTERVAL 6 DAY),
    (generateUUIDv4(), 'backend-gateway', '/api/v1/auth/login', 'POST', 200, 132, '00000000-0000-0000-0000-000000000002', now() - INTERVAL 6 DAY),
    (generateUUIDv4(), 'search-service', '/api/v1/search', 'GET', 200, 89, '00000000-0000-0000-0000-000000000001', now() - INTERVAL 5 DAY),
    (generateUUIDv4(), 'media-service', '/api/v1/media/upload', 'POST', 201, 1250, '00000000-0000-0000-0000-000000000003', now() - INTERVAL 5 DAY),
    (generateUUIDv4(), 'backend-gateway', '/api/v1/auth/login', 'POST', 401, 45, '', now() - INTERVAL 5 DAY),
    (generateUUIDv4(), 'bookmark-service', '/api/v1/bookmarks', 'POST', 201, 67, '00000000-0000-0000-0000-000000000002', now() - INTERVAL 4 DAY),
    (generateUUIDv4(), 'workspace-service', '/api/v1/workspaces/members', 'GET', 200, 41, '00000000-0000-0000-0000-000000000001', now() - INTERVAL 4 DAY),
    (generateUUIDv4(), 'channel-service', '/api/v1/channels/messages', 'GET', 200, 55, '00000000-0000-0000-0000-000000000004', now() - INTERVAL 3 DAY),
    (generateUUIDv4(), 'backend-gateway', '/api/v1/auth/login', 'POST', 200, 138, '00000000-0000-0000-0000-000000000003', now() - INTERVAL 3 DAY),
    (generateUUIDv4(), 'reminder-service', '/api/v1/reminders', 'POST', 201, 78, '00000000-0000-0000-0000-000000000002', now() - INTERVAL 3 DAY),
    (generateUUIDv4(), 'search-service', '/api/v1/search', 'GET', 200, 102, '00000000-0000-0000-0000-000000000002', now() - INTERVAL 2 DAY),
    (generateUUIDv4(), 'media-service', '/api/v1/media/upload', 'POST', 201, 980, '00000000-0000-0000-0000-000000000002', now() - INTERVAL 2 DAY),
    (generateUUIDv4(), 'workspace-service', '/api/v1/workspaces', 'GET', 200, 29, '00000000-0000-0000-0000-000000000003', now() - INTERVAL 2 DAY),
    (generateUUIDv4(), 'backend-gateway', '/api/v1/auth/token/refresh', 'POST', 200, 52, '00000000-0000-0000-0000-000000000001', now() - INTERVAL 1 DAY),
    (generateUUIDv4(), 'channel-service', '/api/v1/channels', 'POST', 201, 95, '00000000-0000-0000-0000-000000000001', now() - INTERVAL 1 DAY),
    (generateUUIDv4(), 'bookmark-service', '/api/v1/bookmarks/user', 'GET', 200, 43, '00000000-0000-0000-0000-000000000002', now() - INTERVAL 1 DAY),
    (generateUUIDv4(), 'backend-gateway', '/api/v1/auth/login', 'POST', 200, 141, '00000000-0000-0000-0000-000000000004', now() - INTERVAL 18 HOUR),
    (generateUUIDv4(), 'search-service', '/api/v1/search', 'GET', 200, 76, '00000000-0000-0000-0000-000000000004', now() - INTERVAL 12 HOUR),
    (generateUUIDv4(), 'media-service', '/api/v1/media', 'GET', 200, 35, '00000000-0000-0000-0000-000000000001', now() - INTERVAL 12 HOUR),
    (generateUUIDv4(), 'workspace-service', '/api/v1/workspaces/stats', 'GET', 200, 125, '00000000-0000-0000-0000-000000000001', now() - INTERVAL 6 HOUR),
    (generateUUIDv4(), 'backend-gateway', '/api/v1/auth/login', 'POST', 200, 128, '00000000-0000-0000-0000-000000000001', now() - INTERVAL 6 HOUR),
    (generateUUIDv4(), 'channel-service', '/api/v1/channels/messages', 'GET', 200, 48, '00000000-0000-0000-0000-000000000002', now() - INTERVAL 3 HOUR),
    (generateUUIDv4(), 'bookmark-service', '/api/v1/bookmarks', 'GET', 200, 38, '00000000-0000-0000-0000-000000000003', now() - INTERVAL 3 HOUR),
    (generateUUIDv4(), 'reminder-service', '/api/v1/reminders/pending', 'GET', 200, 22, '00000000-0000-0000-0000-000000000002', now() - INTERVAL 2 HOUR),
    (generateUUIDv4(), 'media-service', '/api/v1/media/upload', 'POST', 500, 5002, '00000000-0000-0000-0000-000000000004', now() - INTERVAL 1 HOUR),
    (generateUUIDv4(), 'backend-gateway', '/api/v1/auth/login', 'POST', 429, 12, '', now() - INTERVAL 1 HOUR),
    (generateUUIDv4(), 'search-service', '/api/v1/search', 'GET', 200, 95, '00000000-0000-0000-0000-000000000001', now() - INTERVAL 30 MINUTE),
    (generateUUIDv4(), 'workspace-service', '/api/v1/workspaces', 'GET', 200, 31, '00000000-0000-0000-0000-000000000002', now() - INTERVAL 15 MINUTE);
